...
(:For Test:)
module namespace ghg="http://converterstest.eionet.europa.eu";
...
import module namespace common = "ghg-common" at "ghg-common_JSON.xq";
import module namespace dd = "ghg-dd" at "ghg-dd_JSON.xq";
import module namespace html = "ghg-html" at "ghg-html_JSON.xq";
...
:)
declare function ghg:checkLatestInventoryYear($json) {
...
declare function ghg:checkTotalsPresence($json) {
...
(: Main Function:)
declare function ghg:proceed($json as map(*), $url as xs:string
) {
